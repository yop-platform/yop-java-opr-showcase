...
import com.yeepay.yop.sdk.utils.support.CashierSupport;
...
public class PayOrderRequestServiceImpl implements PayOrderRequestService {
    ...
    public String payOrderRequest(PayOrderRequestDTO requestDTO) {
        ...
        String credentialType = "RSA";
        YopPKICredentials yopPKICredentials = (YopPKICredentials) YopCredentialsProviderRegistry.getProvider()
                .getCredentials(appKey, credentialType).getCredential();
        PrivateKey isvPrivateKey = yopPKICredentials.getCredential().getPrivateKey();
