package com.yeepay.demo.shop.modules.product.controller;
...
public class ProductDetailsController extends BaseController {
    ...
    public Map loadProductPropertyList(@PathVariable("pid") String pid/*产品ID*/) {
        logger.info("获取产品ID");
        Integer product_id = Integer.parseInt(pid);
    ...
    public Map guessYouLike(@PathVariable("cid") Integer cid, @RequestParam Integer guessNumber) {
        logger.info("获取猜你喜欢列表");
        ...
        result.put("loveProductList", loveProductList);
        result.put("guessNumber", i);
        return result;
    }
}
