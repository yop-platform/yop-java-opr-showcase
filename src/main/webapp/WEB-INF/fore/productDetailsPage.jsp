...
<head>
    ...
    <title>${requestScope.product.product_name}-yeepay.com易宝</title>
</head>
<body>
<nav>
    ...
    <div class="header">
        <a href="${pageContext.request.contextPath}"><img
                src="${pageContext.request.contextPath}/static/images/fore/WebsiteImage/yeepayLogoB.png"></a>
            ...
            <form action="${pageContext.request.contextPath}/product" method="get">
                <div class="shopSearchInput">
                    <input type="text" class="searchInput" name="product_name" placeholder="搜索 易宝 商品/品牌/店铺"
                           maxlength="50">
                    <input type="submit" value="搜易宝" class="searchTmall">
                </div>
...
<div class="context">
    <div class="context_left">
        <div class="context_img_ks">
            <img src="${pageContext.request.contextPath}/static/images/item/productSinglePicture/${requestScope.product.singleProductImageList[0].productImage_src}"
    ...
    <div class="context_info">
        ...
        <ul class="context_other_panel">
            ...
            <li class="tmall_points">送易宝积分<span><fmt:formatNumber type="number"
                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    if (data.success) {
                                        ...
                                        if (data.url != null) {
                                            location.href = "${ctxPath}" + data.url;
                                        } else {
                                            alert("加入购物车失败，请稍后再试！");
                                        }
                                    }
                ...
                <c:forEach items="${requestScope.loveProductList}" var="product">
                    <li class="context_ul_main">
                        <div class="context_ul_img">
                            <a href="${ctxPath}/product/${product.product_id}">
...
<div class="mainwrap">
    ...
    <div class="J_img">
        <c:forEach items="${requestScope.product.detailProductImageList}" var="image">
            <img src="${pageContext.request.contextPath}/static/images/item/productDetailsPicture/${image.productImage_src}"/>
        </c:forEach>
    </div>
</div>
<div class="msg">
