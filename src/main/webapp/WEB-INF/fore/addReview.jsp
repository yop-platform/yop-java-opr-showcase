...
<head>
    ...
    <title>添加评论 - yeepay.com易宝-理想生活上易宝</title>
    <script>
        $(function () {
    ...
    <div class="details_box">
        <div class="db-showpanel">
            <a href="${pageContext.request.contextPath}/product/${orderItem.productOrderItem_product.product_id}"
               target="_blank"><img
                    src="${pageContext.request.contextPath}/static/images/item/productSinglePicture/${orderItem.productOrderItem_product.singleProductImageList[0].productImage_src}"></a>
        </div>
        <div class="db-icbu">
            <ol class="ui-form-bd">
