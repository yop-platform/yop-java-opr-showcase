...
public class OrderRequestMarshaller implements RequestMarshaller<com.yeepay.demo.yop.sdk.service.trade.request.OrderRequest> {
    ...
    @Override
    public Request<com.yeepay.demo.yop.sdk.service.trade.request.OrderRequest> marshall(com.yeepay.demo.yop.sdk.service.trade.request.OrderRequest request) {
        Request<com.yeepay.demo.yop.sdk.service.trade.request.OrderRequest> internalRequest = new DefaultRequest<OrderRequest>(request, serviceName);
