...
public class OrderCombineQueryRequestMarshaller implements RequestMarshaller<com.yeepay.demo.yop.sdk.service.trade.request.OrderCombineQueryRequest> {
    ...
    @Override
    public Request<com.yeepay.demo.yop.sdk.service.trade.request.OrderCombineQueryRequest> marshall(com.yeepay.demo.yop.sdk.service.trade.request.OrderCombineQueryRequest request) {
        Request<com.yeepay.demo.yop.sdk.service.trade.request.OrderCombineQueryRequest> internalRequest = new DefaultRequest<OrderCombineQueryRequest>(request, serviceName);
